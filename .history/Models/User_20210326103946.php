...
class User
{
    ...
    /**
     * Get store the user type id (foreign key from the users_type table in the database)
     *
     * @return  string
     */
    ...
    /**
     * Set store the user type id (foreign key from the users_type table in the database)
     *
