...
class User
{
    ...
    /**
     * if there is not user with the same data create an new user in the database
     * 
     * @return bool if the user exists return false or the register was unsuccessful
     */
