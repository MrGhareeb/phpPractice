...
class User
{
    ...
    //TODO: initWith($user_id,$f_name,$lName,$email,$password,$userTypeId) set the values of the instance
     ...
     */
    public function register($f_name, $lName, $email,$password,$userTypeId)
    {
        //set the values of the instance
        $this->initWith(null,$f_name,$lName,$email,$password,$userTypeId);
        ...
        if(!$this->existsWithEmail()){
            ...
            $stmt->bind_param("ssssss",$this->f_name,$this->lName,$this->email,$password,$userTypeId);
            //run the sql command
            $stmt->execute();
     ...
     */
    public function initWith($user_id, $f_name, $lName, $email, $password, $userTypeId)
    {
